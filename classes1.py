...
# and appends it to a  'data_file' containing
# other reservations. 'data_file' is created if it does not exist.
# Returns the Reservation object

def bookingGenerator(data_file, interval = 200, max_no_nights = 15):
    try: # sets the sequential 'reservationId'
        ...
        print('File \'' + str(data_file) + '\' does not exist.' +
    ...
    with open(data_file, 'a') as f: #appends reservation
